                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg font-semibold leading-7"><a href="https://github.com/laravel/breeze" class="text-gray-900 underline dark:text-white">Documentation</a></div>
                            </div>
